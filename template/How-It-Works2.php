...
<div class="col-12 col-lg-10 mx-auto p-0" style="margin-top:80px">
	<h1 class="title text-center blue-color">
		10 Steps On How To Get Started On<br>
...
<div class="col-11 col-md-10 mx-auto col-sm-10 mx-auto" style="margin-top:55px">
	...
	<div class="sa-each-step-wrapper sa-left">
<!-- 		<div class="sa-step-each-number" style="border: 1px solid #FF9800;color: #FF9800;box-shadow:0 5px 30px rgba(255,152,0,0.3)">1</div> -->
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-1.png" alt="">
		<p class="sa-step-p">1. Login and complete your registration on the platform</p>
	</div>
	<div class="sa-each-step-wrapper sa-each-step-wrapper-right sa-right">
<!-- 		<div class="sa-step-each-number-right" style="border: 1px solid #94DAEC;color: #94DAEC;box-shadow:0 5px 30px rgba(148,218,236,0.3)">2</div> -->
		<p class="sa-step-p">2. Fill out the Health and Wellness questionnaires</p>
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-2.png" alt="">

	</div>
	<div class="sa-each-step-wrapper sa-left">
<!-- 		<div class="sa-step-each-number" style="border: 1px solid #FFE500;color: #FFE500;box-shadow:0 5px 30px rgba(255,229,0,0.3)">3</div> -->
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-3.png" alt="">
		<p class="sa-step-p">3. Click on the information icon to watch the tutorial on
...
<!-- 		<div class="sa-step-each-number-right" style="border: 1px solid  #8E24AA;color:  #8E24AA;box-shadow:0 5px 30px rgba(142,36,170,0.3)">4</div> -->
		<p class="sa-step-p">4. Schedule an appointment with a Fertility coach</p>
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-4.png" alt="">
	</div>
	<div class="sa-each-step-wrapper d-none d-xl-block n5 n5-desktop">
<!-- 		<div class="sa-step-each-number" style="border: 1px solid #ED0F68;color: #ED0F68;box-shadow:0 5px 30px rgba(237,15,104,0.2)">5</div> -->
		<div class="d-flex align-items-center">
			<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-5.png" alt="" style="position:absolute;left:0">
			<p class="sa-step-p">5. On your home screen, select one of the 11 lifestyle modification pillars<br> that is a
				priority for you, or that has been identified as a priority by your<br> coach</p>
...
<!-- 		<div class="sa-step-each-number" style="border: 1px solid #ED0F68;color: #ED0F68;box-shadow:0 5px 30px rgba(237,15,104,0.2)">5</div> -->
		<div class="d-block  d-sm-flex align-items-center">
			<img class="d-block mx-auto" src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-5.png" alt="">
			<p class="sa-step-p">5. On your home screen, select one of the 11 lifestyle modification pillars that is a
				priority for you, or that has been identified as a priority by your coach</p>

		</div>
		<div id="sa-items5-row" class="col-md-8 mx-auto col-xl-12">
...
<!-- 		<div class="sa-step-each-number-right" style="border: 1px solid  #CDDC39;color:  #CDDC39;box-shadow:0 5px 30px rgba(205,220,57,0.3)">6</div> -->
		<p class="sa-step-p">6. Read the content in the library and try to apply some of<br>
			the recommendations for this pillar</p>
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-6.png" alt="">
	</div>
	<div class="sa-each-step-wrapper sa-left">
<!-- 		<div class="sa-step-each-number" style="border: 1px solid #FF5722;color: #FF5722;box-shadow:0 5px 30px rgba(255,87,34,0.3)">7</div> -->
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-7.png" alt="">
		<p class="sa-step-p">7. Click the “Track My Progress” button to monitor your<br class="d-xl-none">
...
<!-- 		<div class="sa-step-each-number-right" style="border: 1px solid  #673AB7;color:  #673AB7;box-shadow:0 5px 30px rgba(103,58,103,0.3)">8</div> -->
		<p class="sa-step-p">8. Take your time to master each pillar before moving on to<br class="d-xl-none">
			the next one</p>
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-8.png" alt="">
	</div>
	<div class="sa-each-step-wrapper sa-left">
<!-- 		<div class="sa-step-each-number" style="border: 1px solid #18FFFF;color: #18FFFF;box-shadow:0 5px 30px rgba(24,255,255,0.3)">9</div> -->
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-9.png" alt="">
		<p class="sa-step-p">9. Select another pillar as soon as you feel confident with your current one,<br> and
			track your progress (it typically takes 2-3 weeks to make it a part of your<br> daily routine)</p>
	</div>
	<div class="sa-each-step-wrapper sa-each-step-wrapper-right sa-right">
<!-- 		<div class="sa-step-each-number-right" style="border: 1px solid  #FFE500;color:  #FFE500;box-shadow:0 5px 30px rgba(251,251,0,0.3)">10</div> -->
		<p class="sa-step-p">10. Message coaches 24/7 with any questions or advice that you<br>
			need. Take advantage of 1:1 virtual appointments with fertility<br  class="d-xl-none">
			and nutrition experts</p>
		<img src="<?php bloginfo('template_directory'); ?>/images/sa-smp-step-10.png" alt="">
	</div>
