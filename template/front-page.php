...
<input name="submit" type="submit" class="btn btn-primary btn-lg d-none" id="postme1" value="Submit"/>
				...
				<a href="quiz/"  data-countlanding="quizTake"  class="btn p-0 mt-5 mt-sm-3 button-center">
...
<div class="col-12 d-block d-sm-none p-0" style="margin-top:20px">
	...
	<a href="quiz/"  data-countlanding="quizTake"  class="d-flex justify-content-center btn p-0" style="margin-top: -30px;">
...
<p class="m-0 text-center">*Available On iOS And Android Devices *</p>
		...
		<div class="col-lg-4 m-zero d-md-none d-lg-block p-0 text-center">
<!-- 			<img class="max-width-100 tablet" src="<?php bloginfo('template_directory'); ?>/images/1in6.png"> -->
				
			<picture>
				<source media="(max-width:425px)" srcset="<?php bloginfo('template_directory'); ?>/images/habits-mobile.png">
				<img class="max-width-100 tablet" src="<?php bloginfo('template_directory'); ?>/images/habits-mobile.png" width="400">
<!-- 				<img class="max-width-100 tablet" src="<?php bloginfo('template_directory'); ?>/images/habits.png" width="400"> -->
			</picture>
		...
		<div class="col-12 col-lg-3  padding-0 text-right d-flex item1 p0-rotate jc">
			<picture>
				<div id="s1" class="app-poster col-12 w100-rotate width-100 br0 border-rotate1"
					 style="border-radius: 0 30px;width: 93%;">
		...
		<div class="col-12 col-lg-3 text-left d-flex item1 p-0  mt-sm-3 mt-lg-0 jc" style="align-items: flex-end">
			<picture>
				<div id="s3" class="app-poster col-12 border-radius width-100 w100-rotate border-rotate2"
					 style="border-radius: 30px 0;width: 93.5%">
